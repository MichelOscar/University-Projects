IMPLICIT NONE
integer*4 SEED,i,j,L,MCTOT,n,m,npas,DE,ntemp
real*8 genrand_real2,E,energia,mag,magne,temp,x,y,delta,u,ebis,W(-8:8),tvec(5)
integer*2,allocatable:: S(:,:)
integer*4,allocatable:: PBC(:)
character*39 NOM 

NOM="SIM-L-032-TEMP-2000-MCTOT-10K"
...
do I =1,L
do J=1,L
ene=ene-S(i,j)*S(PBC(i+1),i)-S(i,j)*S(i,PBC(j+1))
enddo
enddo
energia=ene
return
